...
I encountered an error sourcing `.zshrc`, stating "autoload command not found", which was due to my still being in Bash rather than Zsh. I had to reinstall it fully again, then log back in and out, and reboot the system.
